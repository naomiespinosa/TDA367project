...
public class Min5a {
  ...
  /**
   * The @login@ method checks if an user is registered and if a valid password
   * is provided, the user is made active. That is, all course related methods
   * are concerning the active user.
  ...
  public void setUsers(List<User> users) {
    for (User user : users)
      userMap.put(user.getPersonNumber(), user);
  }
}
