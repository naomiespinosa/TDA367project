...
public class PageFactory {
  ...
  public static AnchorPane createCoursePanelItem(
      Course course, CourseSelectionPage parentController) throws IOException {
  ...
  public static AnchorPane createCourseMainPage(Course course, CourseSelectionPage parentController)
      throws IOException {
